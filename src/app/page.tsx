      ...
      <header className="flex shrink-0 items-center justify-between px-1 py-2.5">
        ...
        <div className="flex items-center gap-3">
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="flex items-center gap-1.5 rounded-full border border-zinc-600 bg-zinc-800/50 px-3 py-1 text-[11px] font-medium text-zinc-100 transition-colors hover:border-zinc-400 hover:bg-zinc-800 hover:text-white"
          >
