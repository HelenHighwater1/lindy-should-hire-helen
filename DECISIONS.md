...
- [ ] Define TypeScript types for emails, calendar events, contacts, and agent actions
- [ ] Seed initial mock workspace data (realistic enough for demo)
- [ ] Implement read/update helpers for workspace mutations (schedule, email, calendar blocks, etc.)
- [ ] Choose and implement state management (context, Zustand, or similar) — resolve Pending / TBD
- [ ] Smoke: workspace data loads in dev without runtime errors
